              ...
              return (
                ...
                >
                  ...
                  <Button
                    size="icon"
                    variant="ghost"
                    className="size-10 sm:size-8 shrink-0 hover:bg-indigo-500/10 hover:text-indigo-400"
                    onClick={() => copyValue(output)}
                  >
                    {isCopied ? <Check className="size-5 sm:size-4" /> : <Copy className="size-5 sm:size-4" />}
                  </Button>
                </div>
              );
            })}
